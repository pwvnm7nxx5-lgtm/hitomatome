...
[
  ...
  return <div className="app-shell">
    ...
    <main><nav aria-label="メインメニュー"><button aria-current={view === 'today' ? 'page' : undefined} className={view === 'today' ? 'active' : ''} onClick={() => setView('today')}>今日 <b>{todayItems.length}</b></button><button aria-current={view === 'calendar' || view === 'day' ? 'page' : undefined} className={view === 'calendar' || view === 'day' ? 'active' : ''} onClick={() => setView('calendar')}>カレンダー</button><button aria-current={view === 'all' ? 'page' : undefined} className={view === 'all' ? 'active' : ''} onClick={() => setView('all')}>すべて <b>{openItems.length}</b></button><button aria-current={view === 'completed' ? 'page' : undefined} className={view === 'completed' ? 'active' : ''} onClick={() => setView('completed')}>完了済み <b>{completedItems.length}</b></button><button aria-current={['more', 'inbox', 'import', 'help'].includes(view) ? 'page' : undefined} className={['more', 'inbox', 'import', 'help'].includes(view) ? 'active' : ''} onClick={() => setView('more')}>その他</button></nav>
